...
<head>
  ...
  <title><?php echo $_GET['module']; ?> | BIMAGO SumBar</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../index.php" class="logo">
      ...
      <span class="logo-mini"><b>BIMAGO</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>BIMAGO</b> - SumBar</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="https://192.168.25.212/opac">BIMAGO SUMBAR </a>.</strong> All rights reserved.
  </footer>
